...
_admin = %Auth.Admin{}
    |> Auth.Admin.changeset(%{username: "judge", password: Application.fetch_env!(:hub, :admin_pass), emails: ["me@silentsilas.com"]})
    |> Repo.insert!()

_post = %Content.Post{}
    |> Content.Post.changeset(%{
            author: "Silas",
            title: "Super Deep Poem",
...
_unapproved_post = %Content.Post{}
    |> Content.Post.changeset(%{
            author: "Not Silas",
            title: "Not So Deep Poem",
